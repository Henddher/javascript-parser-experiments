...
var grammar = {
    ...
    {"name": "content", "symbols": ["content", "markup_line"], "postprocess": (d) => _trace(d, d=>d, "markup_line")},
    {"name": "content", "symbols": [(lexer.has("any_but_colon") ? {type: "any_but_colon"} : any_but_colon)], "postprocess": (d) => _trace(d, d=>d, "markup_line")},
    {"name": "content", "symbols": ["content", (lexer.has("any_but_colon") ? {type: "any_but_colon"} : any_but_colon)], "postprocess": (d) => _trace(d, d=>d, "markup_line")},
    {"name": "content$ebnf$1", "symbols": [{"literal":":"}]},
    {"name": "content$ebnf$1", "symbols": ["content$ebnf$1", {"literal":":"}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "content", "symbols": ["content$ebnf$1"], "postprocess": (d) => _trace(d, d=>d, "markup_line")},
    {"name": "content", "symbols": ["content", {"literal":":"}], "postprocess": (d) => _trace(d, d=>d, "markup_line")},
