...
var grammar = {
    ...
    {"name": "content", "symbols": ["content", "colons_etc"], "postprocess": (d) => _trace(d, d=>d, "trace")},
    {"name": "colons_etc", "symbols": [(lexer.has("colon2x") ? {type: "colon2x"} : colon2x), "markup_line"], "postprocess": (d) => _trace(d, d=>d[1], "trace")},
    {"name": "colons", "symbols": [(lexer.has("colon2x") ? {type: "colon2x"} : colon2x)], "postprocess": (d) => _trace(d, d=>d, "trace")},
    {"name": "colons", "symbols": ["colons", (lexer.has("colon2x") ? {type: "colon2x"} : colon2x)], "postprocess": (d) => _trace(d, d=>d, "trace")},
