...
var grammar = {
    ...
    {"name": "markup_def", "symbols": ["markup_kw", "markup_end"], "postprocess": (d) => _trace(d, d=>renderMarkup(d[0], []), "markup_def")},
    {"name": "markup_def", "symbols": ["markup_end"], "postprocess": (d) => _trace(d, d=>"", "markup_def")},
